...
export const DESIGN_TOKEN_VALUES = {
  ...
  shadow: {
    small: '0 4px 14px rgba(66, 28, 0, 0.06)',
    panel: '0 14px 36px rgba(66, 28, 0, 0.08)',
    elevated: '0 18px 40px rgba(66, 28, 0, 0.12)',
    focus: '0 0 0 3px rgba(142, 101, 69, 0.24)',
  },
} as const;
