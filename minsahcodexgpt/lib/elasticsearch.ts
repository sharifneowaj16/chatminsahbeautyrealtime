...
export const productIndexMapping = {
  ...
  mappings: {
    properties: {
      ...
      brandSlug:       { type: 'keyword' as const },
      // Phase 2: category/subcategory are slug-safe keyword fields used by the shop URL contract.
      category:        { type: 'keyword' as const },
      categorySlug:    { type: 'keyword' as const },
      categoryName:    { type: 'text' as const, analyzer: 'standard', fields: { keyword: { type: 'keyword' as const } } },
      subcategory:     { type: 'keyword' as const },
      subcategorySlug: { type: 'keyword' as const },
      subcategoryName: { type: 'text' as const, analyzer: 'standard', fields: { keyword: { type: 'keyword' as const } } },
      categoryHierarchy: { type: 'keyword' as const },
      categorySlugHierarchy: { type: 'keyword' as const },
      ...
      // Phase 20: sellable-product visibility fields
      ...
      codAvailable:    { type: 'boolean' as const },
      isCODAvailable:  { type: 'boolean' as const },
      freeShippingEligible: { type: 'boolean' as const },
      returnEligible:  { type: 'boolean' as const },
      authenticityBadge: { type: 'boolean' as const },
      deliveryBadge:   { type: 'keyword' as const, index: false },
      ...
      focusKeyword:    { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      secondaryKeywords: { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      searchTags:      { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      synonyms:        { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      banglaSearchTerms: { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      buyingIntentKeywords: { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      reviewKeywords:  { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
      entities:        { type: 'text' as const, analyzer: 'beauty_search', fields: { keyword: { type: 'keyword' as const } } },
