...
function TrackPageContent() {
  ...
  const formatCustomerDeliveryCharge = (value?: number, label?: string) => {
            ...
            <div className="bg-gradient-to-r from-violet-600 to-purple-600 px-6 py-5">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-3">
                <div className="rounded-xl border border-white/25 bg-white/10 px-4 py-3 text-left">
                  <p className="text-xs font-semibold uppercase tracking-wide text-white/70">Consignment</p>
                  <p className="mt-1 text-sm leading-relaxed text-white">{result.consignmentId || '—'}</p>
                </div>
                <div className="rounded-xl border border-white/25 bg-white/10 px-4 py-3 text-left">
                  <p className="text-xs font-semibold uppercase tracking-wide text-white/70">Delivery Paid</p>
                  <p className="mt-1 text-sm leading-relaxed text-white">
                    {formatCustomerDeliveryCharge(
                      result.customerDeliveryCharge ?? result.deliveryCharge,
                      result.deliveryChargeLabel
                    )}
                  </p>
                </div>
                <div className="rounded-xl border border-white/25 bg-white/10 px-4 py-3 text-left">
                  <p className="text-xs font-semibold uppercase tracking-wide text-white/70">Last Updated</p>
                  <p className="mt-1 text-sm leading-relaxed text-white">
